...
//  PhotoApp
//
//  Created by Nguyễn Việt on 22/08/2022.
//

import UIKit

let PAGING_VIEW_HEIGHT: CGFloat = 40
...
class LoadMoreActivityIndicator {
    ...
    init (scrollView: UIScrollView, spacingFromLastCell: CGFloat, spacingFromLastCellWhenLoadMoreActionStart: CGFloat) {
        ...
        let size:CGFloat = 40
        let frame = CGRect(x: (scrollView.frame.width-size)/2, y: scrollView.contentSize.height + spacingFromLastCell - PAGING_VIEW_HEIGHT, width: size, height: size)
